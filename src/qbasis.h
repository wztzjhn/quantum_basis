...
//  ----------------------------------------------------------------------------
    ...
    public:
        ...
        // translate the basis according to the given plan, or directly according to displacement on a particular lattice
        // sgn = 0 or 1 denoting if extra minus sign generated by translating fermions
        basis_elem& translate(const std::vector<MKL_INT> &plan, MKL_INT &sgn);
